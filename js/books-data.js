...
window.BOOKS = [
  ...
  },
  {
    ...
    covers: [
      ...
      { style: 'tipografica', file: 'img/profetas-y-reyes-tipografica.jpg' }
    ],
    badge: 'Nuevo',
...
// ---- Nuevos libros de Elena G. White (añadidos) ----
  ...
  },
  {
    ...
    covers: [
      ...
      { style: 'tipografica', file: 'img/palabras-de-vida-del-gran-maestro-tipografica.jpg' }
    ],
    badge: 'Nuevo',
  ...
  },
  {
    ...
    covers: [
      ...
      { style: 'tipografica', file: 'img/primeros-escritos-tipografica.jpg' }
    ],
    badge: 'Nuevo',
  ...
  },
  {
    ...
    covers: [
      ...
      { style: 'tipografica', file: 'img/maranatha-el-senor-viene-tipografica.jpg' }
    ],
    badge: 'Nuevo',
  ...
  },
  {
    ...
    covers: [
      ...
      { style: 'tipografica', file: 'img/mensajes-selectos-tomo-i-tipografica.jpg' }
    ],
    badge: 'Nuevo',
  ...
  },
  {
    ...
    covers: [
      { style: 'ilustrada', file: 'img/mensajes-selectos.jpg' },
      { style: 'tipografica', file: 'img/mensajes-selectos-tomo-ii-tipografica.jpg' }
    ],
    badge: 'Nuevo',
  ...
  },
  {
    ...
    covers: [
      { style: 'ilustrada', file: 'img/mensajes-selectos.jpg' },
      { style: 'tipografica', file: 'img/mensajes-selectos-tomo-iii-tipografica.jpg' }
    ],
    badge: 'Nuevo',
...
// ---- Biblias ----
  ...
  },
  {
    ...
    covers: [
      { style: 'tipografica', file: 'img/ser-semejante-a-jesus-tipografica.jpg' }
    ],
    badge: 'Próximamente',
    description: 'Una compilación de escritos de la autora sobre cómo se va formando el carácter de Cristo en el creyente día a día, con enseñanzas prácticas sobre la oración, la humildad y el servicio.',
    idioma: 'Español',
    subcategory: ['vida-de-cristo', 'vida-cristiana'],
  },
  {
    ...
    covers: [
      { style: 'tipografica', file: 'img/reflejemos-a-jesus-tipografica.jpg' }
    ],
    badge: 'Próximamente',
    description: 'Lecturas devocionales breves centradas en reflejar el carácter de Cristo en el trato con los demás, pensadas para acompañar el tiempo diario de oración y estudio.',
    idioma: 'Español',
    subcategory: ['devocionales', 'vida-de-cristo'],
  },
  {
    id: 'recibireis-poder',
    ...
    covers: [
      { style: 'tipografica', file: 'img/recibireis-poder-tipografica.jpg' }
    ],
    badge: 'Próximamente',
    description: 'Una recopilación de escritos sobre la obra del Espíritu Santo en la vida del creyente y de la iglesia, con énfasis en la preparación espiritual para el testimonio y el servicio.',
    idioma: 'Español',
    subcategory: ['vida-cristiana', 'ministerio-y-evangelismo'],
  },
  {
    ...
    covers: [
      { style: 'tipografica', file: 'img/reavivamientos-modernos-tipografica.jpg' }
    ],
    badge: 'Próximamente',
    description: 'Un análisis de los grandes movimientos de reavivamiento religioso y sus frutos a la luz de la profecía bíblica, con discernimiento para distinguir lo genuino de lo pasajero.',
    idioma: 'Español',
    subcategory: ['profecia-y-ultimos-tiempos', 'doctrina-y-fe'],
  },
  {
    ...
    covers: [
      { style: 'tipografica', file: 'img/oscuridad-antes-del-amanecer-tipografica.jpg' }
    ],
    badge: 'Próximamente',
    description: 'Una mirada a los tiempos difíciles que precederán a la segunda venida de Cristo, con el ánimo y la esperanza que la Biblia ofrece para atravesarlos con fe.',
    idioma: 'Español',
    subcategory: ['profecia-y-ultimos-tiempos', 'devocionales'],
  },
  {
    ...
    covers: [
      { style: 'tipografica', file: 'img/obreros-evangelicos-tipografica.jpg' }
    ],
    badge: 'Próximamente',
    description: 'Consejos prácticos dirigidos a pastores, predicadores y obreros de la iglesia sobre la preparación personal, la predicación y el cuidado de las congregaciones.',
    idioma: 'Español',
    subcategory: ['ministerio-y-evangelismo'],
  },
  {
    ...
    covers: [
      { style: 'tipografica', file: 'img/nuestra-elevada-vocacion-tipografica.jpg' }
    ],
    badge: 'Próximamente',
    description: 'Un devocional de lecturas diarias que llama al creyente a vivir a la altura de su vocación cristiana, con textos breves pensados para el estudio de cada mañana.',
    idioma: 'Español',
    subcategory: ['devocionales', 'vida-cristiana'],
  },
  {
    id: 'notas-biograficas-de-elena-g-white',
    title: 'Notas Biográficas de Elena G. White',
    author: 'Elena G. White',
    authorSlug: 'elena-g-white',
    category: 'elena-white',
    categoryLabel: 'Elena G. White',
    ...
    finish: 'Brillo',
    paper: 'Blanco offset',
    cover: 'img/notas-biograficas-de-elena-g-white-tipografica.jpg',
    covers: [
      { style: 'tipografica', file: 'img/notas-biograficas-de-elena-g-white-tipografica.jpg' }
    ],
    badge: 'Próximamente',
    description: 'Un relato biográfico de la vida de la autora, desde su niñez hasta sus últimos años de ministerio, contado en buena parte por quienes la conocieron de cerca.',
    idioma: 'Español',
    subcategory: ['vida-cristiana'],
  },
  {
    ...
    covers: [
      { style: 'tipografica', file: 'img/mi-vida-hoy-tipografica.jpg' }
    ],
    badge: 'Próximamente',
    description: 'Un devocional de lecturas breves para cada día del año, con pensamientos sobre la vida cristiana práctica: el carácter, la familia, el trabajo y la fe cotidiana.',
    idioma: 'Español',
    subcategory: ['devocionales', 'vida-cristiana'],
  },
  {
    id: 'mente-caracter-y-personalidad-1',
    title: 'Mente, Carácter y Personalidad, Tomo 1',
    author: 'Elena G. White',
    authorSlug: 'elena-g-white',
    category: 'elena-white',
    categoryLabel: 'Elena G. White',
    ...
    covers: [
      { style: 'tipografica', file: 'img/mente-caracter-y-personalidad-1-tipografica.jpg' }
    ],
    badge: 'Próximamente',
    description: 'Primer tomo de una compilación sobre la relación entre la mente, el cuerpo y el carácter, con principios prácticos para el desarrollo personal y espiritual.',
    idioma: 'Español',
    subcategory: ['educacion', 'vida-cristiana'],
  },
  {
    id: 'mente-caracter-y-personalidad-2',
    title: 'Mente, Carácter y Personalidad, Tomo 2',
    author: 'Elena G. White',
    authorSlug: 'elena-g-white',
    category: 'elena-white',
    categoryLabel: 'Elena G. White',
    ...
    covers: [
      { style: 'tipografica', file: 'img/mente-caracter-y-personalidad-2-tipografica.jpg' }
    ],
    badge: 'Próximamente',
    description: 'Segundo tomo de la compilación sobre la mente, el cuerpo y el carácter, con enseñanzas sobre los hábitos, la educación y la formación de una personalidad equilibrada.',
    idioma: 'Español',
    subcategory: ['educacion', 'vida-cristiana'],
  },
  {
    ...
    covers: [
      { style: 'tipografica', file: 'img/mensajes-para-los-jovenes-tipografica.jpg' }
    ],
    badge: 'Próximamente',
    description: 'Una compilación de consejos dirigidos especialmente a los jóvenes, sobre la elección de amistades, el carácter, el estudio y el propósito de vida a la luz de la fe.',
    idioma: 'Español',
    subcategory: ['familia-y-hogar', 'vida-cristiana'],
  },
];
...
window.BOOK_NEEDS = {
  ...
  'ser-semejante-a-jesus': ['conocer-a-jesus', 'crecer-cada-dia'],
  'reflejemos-a-jesus': ['conocer-a-jesus', 'crecer-cada-dia'],
  'recibireis-poder': ['crecer-cada-dia', 'servir-y-compartir'],
  'reavivamientos-modernos': ['entender-el-futuro', 'dudas-de-fe'],
  'oscuridad-antes-del-amanecer': ['entender-el-futuro', 'paz-interior'],
  'obreros-evangelicos': ['servir-y-compartir'],
  'nuestra-elevada-vocacion': ['crecer-cada-dia', 'paz-interior'],
  'notas-biograficas-de-elena-g-white': ['crecer-cada-dia', 'primeros-pasos'],
  'mi-vida-hoy': ['crecer-cada-dia'],
  'mente-caracter-y-personalidad-1': ['crecer-cada-dia', 'criar-a-mis-hijos'],
  'mente-caracter-y-personalidad-2': ['crecer-cada-dia', 'criar-a-mis-hijos'],
